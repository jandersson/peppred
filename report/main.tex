...
\begin{document}
	...
	\begin{flushleft}
		{\Large
			\textbf\newline{Predicting signal peptides using language modeling} % Please use "sentence case" for title and headings (capitalize only the first word in a title (or heading), the first word in a subtitle (or subheading), and any proper nouns).
		}
		\newline
